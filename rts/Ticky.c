...
PrintTickyInfo(void)
{
  ...
  unsigned long tot_tag_preds = TAG_UNTAGGED_pred + TAG_UNTAGGED_miss +
                                     TAG_TAGGED_pred   + TAG_TAGGED_miss;
  unsigned long tot_tag_hits  = TAG_TAGGED_pred + TAG_UNTAGGED_pred;
