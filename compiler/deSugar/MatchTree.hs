...
mkCase heuristic ty m knowledge colIndex =
    let column = getCol m colIndex
        ...
        defaultFailure failExpr = if hasDefaultGroup
            then
        ...
        canItFail :: CanItFail
        canItFail = if hasDefaultGroup then CantFail else CanFail
        ...
        mkConAlt :: PGrp -> (CoreExpr -> DsM CoreAlt)
        ...
        ******************* End of Con Grp alt code *******************
        ...
        alts failExpr = do
            ...
            liftM (addDefault grpAlts) (defaultFailure failExpr)
            -- defFailBranch
